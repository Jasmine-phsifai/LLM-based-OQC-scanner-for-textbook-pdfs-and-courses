...
from quality_lab.build_scorer_expectations import build_scorer_expectations
...
from quality_lab.calculate_token_metrics import TokenMetricCounts
...
from quality_lab.generators.phase1_fixture_content import (
    CANONICAL_FORMULAS,
...
from quality_lab.normalize_content_units import NORMALIZATION_VERSION
from quality_lab.normalize_recognized_markdown_v6 import (
    normalize_recognized_markdown_v6,
)
from quality_lab.parse_formula_signature import parse_formula_signature
from quality_lab.score_critical_slots import score_critical_slots
from quality_lab.score_formula_signatures import FormulaScore, score_formula_signatures
from quality_lab.score_ordered_anchors import score_ordered_anchors
from quality_lab.score_table_cells import (
    NEUTRAL_TABLE_LINE_BREAKS,
    ExpectedMarkdownTable,
    score_table_cells,
)
from quality_lab.tokenize_content_units import (
    ContentToken,
    TOKENIZER_VERSION,
...
DEFAULT_PHASE1_MANIFEST_PATH = (
    Path(__file__).parents[0] / "fixtures" / "phase1" / "manifest.json"
)
FROZEN_PHASE1_MANIFEST_SHA256 = (
    "4d1314d7dc31fb57113bbfcab81bcbfeea7e9714a517061229aa34d1f0197bc2"
)
...
_PINNED_SCORING_CONTRACT = {
    ...
    "formula_dialect": "labeled-latex-restricted.v7",
...
def _require_relative_path(value: object, context: str) -> str:
    ...
    if not pure.parts or pure.parts[0] != "quality_lab":
        _invalid(f"{context} must stay under quality_lab/")
